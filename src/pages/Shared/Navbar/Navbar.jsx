  ...
  return (
    <div className="navbar bg-base-100/80 backdrop-blur-md shadow-[0_4px_20px_rgba(0,0,0,0.05)] px-4 lg:px-10 sticky top-0 z-50">
      ...
      <div className="navbar-end gap-2">
        ...
        <button className="btn btn-sm bg-base-200 text-neutral hover:bg-primary hover:text-primary-content border-none rounded-lg transition-all">
          Login
        </button>

        <button className="btn btn-sm bg-primary text-primary-content hover:opacity-90 border-none rounded-lg transition-all">
          Register
        </button>
