...
const Decorator = () => {
  const decorators_data = [
    {
      image: "https://i.ibb.co.com/0Lp4nTg/846e4f05-ab90-4cd6-941e-2273efeeddf8.jpg",
    ...
    {
      image: "https://i.ibb.co.com/67jBMBPF/f8ecc39e-ce11-4ee4-a352-32b449da9135.jpg",
    ...
    {
      image: "https://i.ibb.co.com/ksjrzD4t/1d8079e9-9974-43b3-a49e-39ca903906c1.jpg",
    ...
    {
      image: "https://i.ibb.co.com/7tnKzJd1/9b6d20a7-a7ce-4f9f-a1a1-8b177b431977.jpg",
      ...
      <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8 mb-14">
        ...
        <div className="max-w-2xl">
          ...
          <p className="text-neutral/70 text-sm md:text-lg leading-8">
            Collaborate with highly experienced decoration specialists
            dedicated to creating elegant weddings, birthdays, interiors,
            and luxury event experiences.
          </p>
